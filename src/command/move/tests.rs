...
mod tests_int {
    ...
    //TODO Fix the rest of the tests as above (But it should only be nessesary to do for the error cases

//     #[test]
//     fn test_execute_move_command_index_out_of_bounds() {
//         let mut game = new_testing(Some([1; 16]));
//
//         let result = execute(&mut game, 11).expect_err("Test failed!");
//
//         assert_eq!(
//             "Error: execute_move_command: Index 11 is out of range of places, places is 10 long.",
//             format!("{}", result.into())
//         );
...
//         );
//         assert_eq!(
//             "Costs paid and all gains executed.",
...
//         assert_eq!(
//             "MyError { kind: ExecuteCommand { error_message: \"Did not fulfill the \
//              FlatMaxAttackRequirement of 1 Physical damage, did {Physical: 3} damage and that is \
//              too much.\" } }",
//             result.item_report[2].effect_description
//         );
//     }
...
//         assert_eq!(
//             "MyError { kind: ExecuteCommand { error_message: \"Did not fulfill the \
//              FlatSumMaxAttackRequirement of 20 damage, did {Physical: 22} damage damage and that \
//              is too much.\" } }",
//             result.item_report[4].effect_description
//         );
//     }
...
//         );
//
//         let result = execute(&mut game, 7).expect_err("Test failed!");
//
//         assert_eq!(
//             "You did not deal enough damage to overcome the challenges in this place.",
//             format!("{}", result.into())
...
//         assert_eq!(
//             "MyError { kind: ExecuteCommand { error_message: \"Did not fulfill the \
//              FlatMaxResistanceRequirement of 17 Fire damage, place has 20 damage and that is too \
//              much.\" } }",
//             result.item_report[0].effect_description
//         );
//     }
...
//         game.equipped_items.push(first_item_cannot_pay);
//
//         let result = execute(&mut game, 9).expect_err("Test failed!");
//
//         assert_eq!(
//             "You did not deal enough damage to overcome the challenges in this place.",
//             format!("{}", result.into())
...
//         assert_eq!(
//             "MyError { kind: ExecuteCommand { error_message: \"Did not fulfill the \
//              FlatMaxSumResistanceRequirement of 194 damage, place has 241 damage and that is too \
//              much.\" } }",
//             result.item_report[0].effect_description
//         );
//     }
...
//         );
//         assert_eq!(
//             "MyError { kind: ExecuteCommand { error_message: \"Did not fulfill the MinWinsInARow \
//              of 1 win, only hase 0 wins in a row.\" } }",
//             result.item_report[0].effect_description
//         );
//         assert_eq!(
//             "Costs paid and all gains executed.",
...
//         );
//         assert_eq!(
//             "MyError { kind: ExecuteCommand { error_message: \"Did not fulfill the MaxWinsInARow \
//              of 0 win, have 1 wins in a row and that is too much.\" } }",
//             result.item_report[0].effect_description
//         );
//         assert_eq!(
//             "Costs paid and all gains executed.",
...
//         let result = execute(&mut game, 0).expect_err("Test failed!");
//
//         assert_eq!(format!("{}", result.into())
//             .contains("You did not deal enough damage to overcome the challenges in this place."));
//         assert_eq!(
//             "Costs paid and all gains executed.",
//             result.item_report[0].effect_description
//         );
